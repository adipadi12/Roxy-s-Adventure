...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_MyProject_OnPickUp__DelegateSignature_Statics::NewProp_PickUpCharacter = { "PickUpCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_MyProject_eventOnPickUp_Parms, PickUpCharacter), Z_Construct_UClass_AMyProjectCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
void FOnPickUp_DelegateWrapper(const FMulticastScriptDelegate& OnPickUp, AMyProjectCharacter* PickUpCharacter)
{
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp = { "OnPickUp", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UTP_PickUpComponent, OnPickUp), Z_Construct_UDelegateFunction_MyProject_OnPickUp__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp_MetaData)) }; // 1073220479
	...
	struct Z_CompiledInDeferFile_FID_Users_ajha4_OneDrive_Documents_Unreal_Projects_MyProject_Source_MyProject_TP_PickUpComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ajha4_OneDrive_Documents_Unreal_Projects_MyProject_Source_MyProject_TP_PickUpComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_PickUpComponent, UTP_PickUpComponent::StaticClass, TEXT("UTP_PickUpComponent"), &Z_Registration_Info_UClass_UTP_PickUpComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_PickUpComponent), 4090617009U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ajha4_OneDrive_Documents_Unreal_Projects_MyProject_Source_MyProject_TP_PickUpComponent_h_3082167424(TEXT("/Script/MyProject"),
		Z_CompiledInDeferFile_FID_Users_ajha4_OneDrive_Documents_Unreal_Projects_MyProject_Source_MyProject_TP_PickUpComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ajha4_OneDrive_Documents_Unreal_Projects_MyProject_Source_MyProject_TP_PickUpComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
